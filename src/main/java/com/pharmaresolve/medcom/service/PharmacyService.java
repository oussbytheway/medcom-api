...
public class PharmacyService {
    ...
    /**
     * Get all the pharmacies with eager load of many-to-many relationships.
     *
     * @return the list of entities.
     */
    public Page<PharmacyDTO> findAllWithEagerRelationships(Pageable pageable) {
        return pharmacyRepository.findAllWithEagerRelationships(pageable).map(pharmacyMapper::toDto);
    }
    ...
    public Optional<PharmacyDTO> findOne(Long id) {
        ...
        return pharmacyRepository.findOneWithEagerRelationships(id).map(pharmacyMapper::toDto);
    }
