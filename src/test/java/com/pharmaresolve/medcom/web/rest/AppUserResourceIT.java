...
class AppUserResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_ACCESS_CODE_EXPIRATION_DATE = ZonedDateTime.ofInstant(
        Instant.ofEpochMilli(0L),
        ZoneOffset.UTC
    );
    private static final ZonedDateTime UPDATED_ACCESS_CODE_EXPIRATION_DATE = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    void getAllAppUsers() throws Exception {
        ...
        restAppUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].accessCodeExpirationDate").value(hasItem(sameInstant(DEFAULT_ACCESS_CODE_EXPIRATION_DATE))))
    ...
    void getAppUser() throws Exception {
        ...
        restAppUserMockMvc
            ...
            .andExpect(jsonPath("$.accessCodeExpirationDate").value(sameInstant(DEFAULT_ACCESS_CODE_EXPIRATION_DATE)))
