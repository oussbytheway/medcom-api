...
class AlertResourceIT {
    ...
    private static final AlertType DEFAULT_TYPE = AlertType.AVAILABILITY;
    private static final AlertType UPDATED_TYPE = AlertType.LOW_STOCK;
    ...
    void partialUpdateAlertWithPatch() throws Exception {
        ...
        partialUpdatedAlert.type(UPDATED_TYPE).status(UPDATED_STATUS).created(UPDATED_CREATED).resolvedAt(UPDATED_RESOLVED_AT);
